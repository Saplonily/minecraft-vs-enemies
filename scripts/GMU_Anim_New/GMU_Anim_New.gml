/// @description GMU_Anim_New(target, var_name, tween, ease, start, change, duration, delay, arg1, arg2*);
/// @param target
/// @param  var_name
/// @param  tween
/// @param  ease
...
function GMU_Anim_New() {
	...
	inst_result[proc_result]=New(_gmu_anim);
