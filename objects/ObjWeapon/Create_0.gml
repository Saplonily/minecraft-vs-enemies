...
var atkpart = PtAtk;
part_type_life(atkpart,10*sec1/30,20*sec1/30) //设置粒子效果的死亡周期
part_type_shape(atkpart,ps_shape_diamond)
part_type_direction(atkpart,-60,140,0,0)
part_type_speed(atkpart,0.6*tick1,2*tick1,-0.01*tick1,0)
part_type_scale(atkpart,0.1,0.1)
part_type_colour2(atkpart,c_gray,c_black)
part_type_gravity(atkpart,0.08*tick1,270)
